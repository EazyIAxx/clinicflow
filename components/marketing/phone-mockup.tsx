...
const screens = [
  { key: "agenda", label: "Agenda", Component: AgendaScreen },
  { key: "whatsapp", label: "Automações WhatsApp", Component: WhatsAppScreen },
  { key: "relatorios", label: "Relatórios", Component: RelatoriosScreen },
  { key: "prontuario", label: "Prontuário", Component: ProntuarioScreen },
];
        ...
        {screens.map((screen, index) => (
          <span
            ...
            className={`h-1.5 rounded-full transition-all ${
              index === screenIndex ? "bg-primary w-5" : "bg-muted-foreground/30 w-1.5"
            }`}
          />
        ))}
      </div>
