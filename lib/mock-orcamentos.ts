  ...
  return [
    {
      ...
      items: [
        { id: "item-1", procedureId: "proc-6", amount: 250 },
        { id: "item-2", procedureId: "proc-7", amount: 380 },
      ],
      discountPercent: 0,
    ...
    },
    {
      ...
      items: [
        { id: "item-3", procedureId: "proc-1", amount: 150 },
        { id: "item-4", procedureId: "proc-2", amount: 450 },
      ],
      discountPercent: 10,
    ...
    },
    {
      ...
      items: [{ id: "item-5", procedureId: "proc-3", amount: 1800 }],
      discountPercent: 5,
    ...
    },
    {
      ...
      patientId: "pac-8",
      responsibleProfessionalId: "prof-3",
      items: [{ id: "item-6", procedureId: "proc-6", amount: 250 }],
      discountPercent: 0,
      validUntil: ago(5),
      status: "recusado",
    ...
    },
    {
      ...
      items: [
        { id: "item-7", procedureId: "proc-9", amount: 220 },
        { id: "item-8", procedureId: "proc-10", amount: 540 },
      ],
      discountPercent: 15,
    ...
    },
    {
      ...
      patientId: "pac-11",
      responsibleProfessionalId: "prof-2",
      items: [{ id: "item-9", procedureId: "proc-4", amount: 180 }],
      discountPercent: 0,
      validUntil: future(7),
      status: "enviado",
      createdAt: ago(3),
    },
    {
      ...
      patientId: "pac-2",
      responsibleProfessionalId: "prof-2",
      items: [{ id: "item-10", procedureId: "proc-4", amount: 360 }],
      discountPercent: 0,
      validUntil: ago(10),
      status: "expirado",
      createdAt: ago(40),
    },
    {
      ...
      items: [{ id: "item-11", procedureId: "proc-8", amount: 1040 }],
      discountPercent: 8,
    ...
    },
    {
      ...
      responsibleProfessionalId: "prof-3",
      items: [
        { id: "item-12", procedureId: "proc-6", amount: 250 },
        { id: "item-13", procedureId: "proc-7", amount: 380 },
      ],
      discountPercent: 0,
      validUntil: future(30),
      status: "rascunho",
    ...
    },
    {
      ...
      patientId: "pac-10",
      responsibleProfessionalId: "prof-1",
      items: [{ id: "item-14", procedureId: "proc-2", amount: 450 }],
      discountPercent: 0,
      validUntil: ago(2),
      status: "recusado",
      createdAt: ago(18),
